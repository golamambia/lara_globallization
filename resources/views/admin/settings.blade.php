          ...
          <form type="form" action="{{ url('/admin/settings') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
            ...
            <div class="box-body">
              ...
              <div class="form-group clearfix">
                ...
                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 1 Title</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="site_footer1_title" id="site_footer1_title" placeholder="Enter ..." value="{!!config('site.footer1_title')!!}">
                  </div>
                </div>

                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer Map</label>
                  <div class="col-sm-10">
                    <input type="file" name="site_footer_map">
                    Mime Type: jpeg,png,jpg,gif,svg, Max image upload size 2 Mb<br>

                    <div class="clearfix">
                      <?php
                      if($site_footer_map && File::exists(public_path('uploads/'.$site_footer_map)) )
                      {
                        ?>
                        <img src="{{ asset('/uploads/'.$site_footer_map) }}" style="margin: 10px 0 0 0; max-width: 200px;background: #033355;">
                        <?php
                      }
                      ?>
                    </div>
                ...
                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 2 Title</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 2 Sub Title</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="site_footer2_sub_title" id="site_footer2_sub_title" placeholder="Enter ..." value="{!!config('site.footer2_sub_title')!!}">
                  </div>
                </div>

                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 3 Title</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 4 Title</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 5 Title</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group clearfix">
                  <label class="col-sm-2 control-label">Footer 5 Sub Title</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="site_footer5_sub_title" id="site_footer5_sub_title" placeholder="Enter ..." value="{!!config('site.footer5_sub_title')!!}">
                  </div>
                </div>
