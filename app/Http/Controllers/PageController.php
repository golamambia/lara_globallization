...
class PageController extends Controller
{
	...
	public function contactform(Request $request)
	{
		...
		else
		{
			...
			Phone: ".$phone."<br>
			Which Country You area Looking for Services: ".$service."<br>
			Where are you located?: ".$located."<br>
			What can we help you with?: ".$help."<br>
			Remarks: ".$remark."<br><br>";
	...
	public function ShowPage($slug)
	{
		...
		if($page)
		{
			...
			if ($page->page_template=='1') {
				...
				return view('frontend.pages.service1', compact('page','setting','page_url','page_image', 'extra_data'));
			}else{
